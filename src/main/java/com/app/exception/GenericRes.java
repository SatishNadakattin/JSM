...
import static com.app.util.Status.FAILURE;
import static com.app.util.Status.SUCCESS;
import static com.app.exception.BankRestException.INTERNAL_ERROR_CODE;
...
//	private Map<String, Object> meta;
	...
	public GenericRes(Throwable exception) {
		...
		if (exception instanceof BankRestException) {
			BankRestException ae = (BankRestException) exception;
			status =  FAILURE;
...
//			this.meta = ae.getMeta();
			...
			resCode = INTERNAL_ERROR_CODE;  //if there is no proper error code
			message = exception.getMessage();
			status =  FAILURE;
		}
	}
