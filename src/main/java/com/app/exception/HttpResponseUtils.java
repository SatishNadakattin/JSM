...
//COMMON_HTTP_HEADERS_MAP.add("Access-Control-Allow-Origin", "*");
	...
	public static final ResponseEntity<GenericRes> prepareErrorResponse(final BankRestException ex) {
...
// public static final <T> ResponseEntity<GenericRes> prepareSuccessResponse(final Date timestamp, String message, T data, String status
// return prepareSuccessResponse(date, message, null);
// }
//
